...
import { User, Globe, Save, Eye, EyeOff, CheckCircle } from 'lucide-react'
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      onChange={handleInputChange}
                      className={`w-full px-3 py-2 pr-10 border rounded-lg focus:ring-2 focus:ring-brand-gold focus:border-brand-gold ${
          ...
          <div className="space-y-6">
            <div>
              ...
              <select
                ...
                onChange={handleInputChange}
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-gold focus:border-brand-gold"
              >
                {languages.map((lang) => (
